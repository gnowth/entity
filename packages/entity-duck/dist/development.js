...
import PropTypesPlus$1 from '@gnowth/prop-types-plus';
...
var withQueryDuckContainer = _compose(withPropTypes({
  ...
  propTypes: exact({
    ...
    component: PropTypesPlus$1.component,
...
QueryDuck.propTypes = {
  ...
  children: PropTypesPlus$1.isRequiredIfNot('component', PropTypes.func),
  clear: PropTypes.func.isRequired,
  entity: PropTypes.shape({
    duck: PropTypes.instanceOf(Duck),
    prototype: PropTypes.instanceOf(Entity)
  }).isRequired,
  component: PropTypesPlus$1.isRequiredIf('componentProps', PropTypesPlus$1.component),
  componentProps: PropTypes.shape({}),
  id: PropTypes.string,
  ...
  processingComponent: PropTypesPlus$1.isRequiredIf('processingComponentProps', PropTypesPlus$1.component),
  processingComponentProps: PropTypes.shape({}),
  processingDidFail: PropTypes.bool.isRequired,
  processingDidFailComponent: PropTypesPlus$1.isRequiredIf('processingDidFailComponentProps', PropTypesPlus$1.component),
  processingDidFailComponentProps: PropTypes.shape({}),
  recordsCountComponent: PropTypesPlus$1.isRequiredIf('recordsCountComponentProps', PropTypesPlus$1.component),
  recordsCountComponentProps: PropTypes.shape({}),
  recordsCountHidden: PropTypes.bool,
  recordsCountNoneComponent: PropTypesPlus$1.isRequiredIf('recordsCountNoneComponentProps', PropTypesPlus$1.component),
  recordsCountNoneComponentProps: PropTypes.shape({}),
