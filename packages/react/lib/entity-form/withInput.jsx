...
import { withFormConsumer, withFormDefaultConsumer } from './context';
...
export default function (ComposedComponent) {
  ...
  return _compose(
    withFormDefaultConsumer,
    withFormConsumer,
    withPropTypes(props => {
      const field = props.field || props.formField;

      return {
        defaultProps: {
          disabled: props.formDisabled,
          initialValue: field.getValue(props.formInitialValue, { name: props.name }),
          value: props.formField.getValue(props.formValue, { name: props.name }),
        },
    })),
  )(withFormConsumer);
}
