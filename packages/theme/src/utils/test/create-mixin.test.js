...
describe('createMixin', () => {
  ...
  test('props value as a number with scale as name', () => {
    const theme = {
  ...
  test('props value as a number with scale as function', () => {
    const mixin = createMixin({
      css: 'margin',
      prop: '$margin',
  ...
  test('props value as a number with scale as array', () => {
    const mixin = createMixin({
      css: 'margin',
      prop: '$margin',
      scale: ['0', '1rem', '16rem'],
